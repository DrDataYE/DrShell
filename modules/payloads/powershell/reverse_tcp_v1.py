...
metadata = {
    ...
    'options': {
        'lhost': {'type': 'address', 'description': 'Target host address', 'required': True, 'default': '0.0.0.0'},
        'lport': {'type': 'int', 'description': 'Listening port for incoming connections', 'required': False, 'default': 6501},
        'encode': {'type': 'string', 'description': 'Encoding method for the shell', 'required': False, 'default': 'http'},
    }
}
