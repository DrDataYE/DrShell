...
# Metadata for a Unix-based reverse shell using netcat and named pipes
metadata = {
    "name": "NetcatPipeShell Reverse Shell",
    "description": "A Unix-based reverse shell that utilizes netcat and named pipes for remote command execution.",
    "authors": ["DrDataYE"],
    "date": "2023-04-01",
